exports.config = {
  user: process.env.BROWSERSTACK_USERNAME_BS,
  key: process.env.BROWSERSTACK_ACCESS_KEY_BS,

  capabilities: [
    {
      name: "webdriverio-appium",
      build: "Webdriverio Appium Example",
      device: "iPhone 11",
      browserName: "iOS",
      app:
        process.env.BROWSERSTACK_APP_ID ||
        "bs://4db7770c9e6c8329ff6873789a1ed43a6150c0d3",
